        ...
        <div className="relative h-14 sm:h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-4 min-w-0">
            ...
            <Link href="/" className="flex items-center gap-2 sm:gap-3 group relative shrink-0">
              ...
              {/* Logo Text — always visible, smaller on mobile */}
            ...
            {/* Snippets Link — always visible, compact on mobile */}
            <Link
              href="/snippets"
              className="shrink-0 relative group flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-4 py-1 sm:py-1.5 rounded-lg text-gray-300 bg-gray-800/50 hover:bg-blue-500/10 
